 ...
 * 
 */
package es.caib.distribucio.core.api.service.ws;
...
@XmlType(name = "distribucioBackofficeResultatProces", propOrder = {
    "error",
    "errorCodi",
    "errorDescripcio"})
public class DistribucioBackofficeResultatProces implements Serializable {
