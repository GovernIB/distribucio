package es.caib.distribucio.core.api.service.bantel.ws.v2;
...
@XmlSeeAlso({es.caib.distribucio.core.api.service.bantel.ws.v2.model.ObjectFactory.class})
public interface BantelBackofficeWs {
    ...
    public es.caib.distribucio.core.api.service.bantel.ws.v2.model.TramiteBTE obtenerEntrada(
        ...
        es.caib.distribucio.core.api.service.bantel.ws.v2.model.ReferenciaEntrada numeroEntrada
    ) throws BantelBackofficeWsException;
