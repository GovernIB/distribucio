...
import es.caib.distribucio.rest.client.bustia.BustiaRestClient;
import es.caib.distribucio.rest.client.bustia.domini.Firma;
import es.caib.distribucio.rest.client.bustia.domini.RegistreAnnex;
import es.caib.distribucio.rest.client.bustia.domini.RegistreAnotacio;
import es.caib.distribucio.rest.client.bustia.domini.RegistreInteressat;

public class BustiaRestTest {
    ...
    private static final String SERVEI_CODI = "885322";
	...
	private static final String EXTRACTE = "[REST] Alta anotació " + new SimpleDateFormat("yyyy.MM.dd HH.mm.ss").format(new Date());
...
//		put("eni:fecha_sellado", "20/11/2021");
	...
	private BustiaRestClient bustiaRestClient;
 
	@Before
    public void setUp() throws IOException {
		Properties testProperties = getTestProperties();
		
		String base_url = testProperties.getProperty("bustia.test.service.rest.url");
		String username = testProperties.getProperty("bustia.test.service.rest.username");
		String password = testProperties.getProperty("bustia.test.service.rest.password");
		
        bustiaRestClient = new BustiaRestClient(base_url, username, password);
	}
	
	@Test
    public void testAltaAnotacio() throws IOException, DatatypeConfigurationException {
...
//				        		firmes);
	...
	private RegistreAnnex crearAnnex(
        ...
        annex.setEniDataCaptura(new Date());
        ...
        Map<String, String> metaDades = new HashMap<String, String>();
		for (String key : metaDadesMap.keySet()) {
			metaDades.put(key, metaDadesMap.get(key));
		}
