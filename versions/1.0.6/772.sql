...
INSERT INTO DIS_CONFIG (KEY,VALUE,DESCRIPTION,GROUP_CODE,POSITION,JBOSS_PROPERTY,TYPE_CODE) VALUES ('es.caib.distribucio.tasca.enviar.anotacions.backoffice.temps.espera.comunicada', null, 'Iterval de temps entre les execucions de la tasca (ms). Per defecte 60000', 'SCHEDULLED_COMUNICAT_A_PENDENT', '1', '0', 'INT');
INSERT INTO DIS_CONFIG (KEY,VALUE,DESCRIPTION,GROUP_CODE,POSITION,JBOSS_PROPERTY,TYPE_CODE) VALUES ('es.caib.distribucio.tasca.enviar.anotacions.backoffice.maxim.temps.estat.comunicada', null, 'Màxim de dies que pot estar comunicada abans de canviar l''estat a pendent d''usuari. Per defecte 30.', 'SCHEDULLED_COMUNICAT_A_PENDENT', '2', '0', 'INT');
