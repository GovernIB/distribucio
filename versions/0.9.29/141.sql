...
ALTER TABLE DIS_CONT_LOG_PARAM ADD CONSTRAINT DIS_CONT_LOG_CONT_LOG_PARAM_FK FOREIGN KEY (CONT_LOG_ID) REFERENCES DIS_CONT_LOG(ID);GRANT SELECT, UPDATE, INSERT, DELETE ON DIS_CONT_LOG_PARAMTO WWW_DISTRIBUCIO;
