...
ALTER TABLE DIS_SERVEI ADD 
	CONSTRAINT dis_servei_entitat_fk FOREIGN KEY (entitat) REFERENCES DIS_ENTITAT(id);
	
ALTER TABLE DIS_SERVEI ADD 
	CONSTRAINT dis_servei_unitat_fk FOREIGN KEY (id_unitat_organitzativa) REFERENCES DIS_UNITAT_ORGANITZATIVA(id);
