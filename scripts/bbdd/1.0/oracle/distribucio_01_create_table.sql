...
(
  ...
  ENTITAT_DEFECTE_ID    NUMBER(19),
  NUM_ELEMENTS_PAGINA   NUMBER(19),
  EMAIL_ERROR_ANOTACIO  NUMBER(1) DEFAULT 0
);
...
(
    ...
    TIPUS VARCHAR2(32 CHAR) DEFAULT 'SOAP' NOT NULL,
...
(	
	...
	NUMERO_REGISTRE     VARCHAR2(300 CHAR)
);
...
(
  ...
  LASTMODIFIEDBY_CODI  		VARCHAR2(64 CHAR),
  LASTMODIFIEDDATE     		TIMESTAMP(6),
  COMU                      NUMBER(1)   DEFAULT 0 NOT NULL
);
...
CREATE TABLE DIS_EXECUCIO_MASSIVA (	
	...
	LASTMODIFIEDBY_CODI VARCHAR2(64 CHAR), 
	LASTMODIFIEDDATE 	TIMESTAMP (6),
	NOM_DOCUMENT        VARCHAR2(1024 CHAR)
 );
