...
CREATE INDEX DIS_ENTITAT_METADADA_FK_I ON DIS_METADADA(ENTITAT_ID);
CREATE INDEX DIS_USUCRE_METADADA_FK_I ON DIS_METADADA(CREATEDBY_CODI);
CREATE INDEX DIS_USUMOD_METADADA_FK_I ON DIS_METADADA(LASTMODIFIEDBY_CODI);
...
CREATE INDEX DIS_ARXIU_REGLA_FK_I ON DIS_REGLA(ARXIU_ID);
