...
-- Afegeix la columna
ALTER TABLE DIS_AVIS ADD ENTITAT BIGINT;
-- Afegeix la clau forana
 ALTER TABLE DIS_AVIS ADD CONSTRAINT DIS_AVIS_ENT_FK FOREIGN KEY (ENTITAT) REFERENCES DIS_ENTITAT (ID);
...
ALTER TABLE DIS_REGLA ADD TRAMIT_CODI character varying(1024);
