...
ALTER TABLE ONLY DIS_REGISTRE ADD CONSTRAINT DIS_REG_MULT_UK UNIQUE (ENTITAT_CODI, LLIBRE_CODI, TIPUS, NUMERO, DATA, NUMERO_COPIA);
...
ALTER TABLE ONLY DIS_BUSTIA_FAVORIT ADD CONSTRAINT DIS_BUSTIA_FAV_BUSTIA_FK FOREIGN KEY (BUSTIA_ID) REFERENCES DIS_BUSTIA (ID);
ALTER TABLE ONLY DIS_BUSTIA_FAVORIT ADD CONSTRAINT DIS_BUSTIA_FAV_USUARI_FK FOREIGN KEY (USUARI_CODI) REFERENCES DIS_USUARI (CODI);
ALTER TABLE ONLY DIS_BUSTIA_FAVORIT ADD CONSTRAINT DIS_USUCRE_BUSTFAV_FK FOREIGN KEY (CREATEDBY_CODI) REFERENCES DIS_USUARI (CODI);
ALTER TABLE ONLY DIS_BUSTIA_FAVORIT ADD CONSTRAINT DIS_USUMOD_BUSTFAV_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) REFERENCES DIS_USUARI (CODI);
ALTER TABLE ONLY DIS_BUSTIA_FAVORIT ADD CONSTRAINT DIS_BUSTIA_FAV_MULT_UK UNIQUE (BUSTIA_ID, USUARI_CODI);
...
ALTER TABLE DIS_MON_INT ADD CONSTRAINT DIS_MON_INT_PK PRIMARY KEY (ID);

ALTER TABLE DIS_MON_INT_PARAM ADD CONSTRAINT DIS_MON_INT_PARAM_PK PRIMARY KEY (ID);

ALTER TABLE DIS_MON_INT_PARAM ADD CONSTRAINT DIS_MONINTPARAM_MONINT_FK 
	FOREIGN KEY (MON_INT_ID) REFERENCES DIS_MON_INT(ID);
  
ALTER TABLE DIS_PROCEDIMENT ADD CONSTRAINT DIS_PROCEDIMENT_PK PRIMARY KEY (ID);
...
ALTER TABLE DIS_METADADA ADD CONSTRAINT DIS_METADADA_PK PRIMARY KEY (ID);
ALTER TABLE DIS_METADADA ADD CONSTRAINT DIS_METADADA_CODI_UK UNIQUE (CODI);
ALTER TABLE DIS_METADADA ADD CONSTRAINT DIS_METADADA_ENTITAT_FK FOREIGN KEY (ENTITAT_ID) REFERENCES DIS_ENTITAT (ID);
ALTER TABLE DIS_METADADA ADD CONSTRAINT DIS_USUCRE_METADADA_FK FOREIGN KEY (CREATEDBY_CODI) REFERENCES DIS_USUARI (CODI);
ALTER TABLE DIS_METADADA ADD CONSTRAINT DIS_USUMOD_METADADA_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) REFERENCES DIS_USUARI (CODI);

ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_DADA_PK PRIMARY KEY (ID);
ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_DADA_MULT_UK UNIQUE (METADADA_ID, REGISTRE_ID, ORDRE);
ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_REGISTRE_DADA_FK FOREIGN KEY (REGISTRE_ID) REFERENCES DIS_REGISTRE (ID);
ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_METADADA_DADA_FK FOREIGN KEY (METADADA_ID) REFERENCES DIS_METADADA (ID);
ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_USUCRE_DADA_FK FOREIGN KEY (CREATEDBY_CODI) REFERENCES DIS_USUARI (CODI);
ALTER TABLE DIS_DADA ADD CONSTRAINT DIS_USUMOD_DADA_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) REFERENCES DIS_USUARI (CODI);
    
ALTER TABLE DIS_DOMINI ADD CONSTRAINT DIS_DOMINI_PK PRIMARY KEY (ID);

ALTER TABLE DIS_DOMINI ADD CONSTRAINT DIS_ENTITAT_DOMINI_Fk FOREIGN KEY (ENTITAT_ID) REFERENCES DIS_ENTITAT (ID);
...
ALTER TABLE dis_limit_canvi_estat ADD CONSTRAINT dis_limit_canvi_estat_pk PRIMARY KEY (id)
