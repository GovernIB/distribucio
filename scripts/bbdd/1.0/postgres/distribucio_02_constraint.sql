...
ALTER TABLE DIS_REGISTRE_ADIS_UNITAT_ORGANITZATIVNNEX_FIRMA ADD CONSTRAINT DIS_USUCRE_REGANXFIR_FK FOREIGN KEY (CREATEDBY_CODI) REFERENCES DIS_USUARI (CODI);
