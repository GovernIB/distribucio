...
public class DistribucioApiInternaApp extends SpringBootServletInitializer {

	public static void main(String[] args) {
		SpringApplication.run(DistribucioApiInternaApp.class, args);
	}
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		try {
			...
			log.info("Carregant l'aplicació " + BaseConfig.APP_NAME + "-api-interna versió " + version + " generada en data " + buildTimestamp);
