...
public class ObjectFactory {
    ...
    private final static QName _DeleteRequestSearchCriterias_QNAME = new QName("", "search-criterias");
    ...
    public JAXBElement<SearchCriterias> createDeleteRequestSearchCriterias(SearchCriterias value) {
        return new JAXBElement<SearchCriterias>(_DeleteRequestSearchCriterias_QNAME, SearchCriterias.class, DeleteRequest.class, value);
    }
    ...
    public JAXBElement<SearchCriterias> createSearchRequestSearchCriterias(SearchCriterias value) {
        return new JAXBElement<SearchCriterias>(_DeleteRequestSearchCriterias_QNAME, SearchCriterias.class, SearchRequest.class, value);
    }
    ...
    public JAXBElement<SearchCriterias> createListRequestSearchCriterias(SearchCriterias value) {
        return new JAXBElement<SearchCriterias>(_DeleteRequestSearchCriterias_QNAME, SearchCriterias.class, ListRequest.class, value);
    }
