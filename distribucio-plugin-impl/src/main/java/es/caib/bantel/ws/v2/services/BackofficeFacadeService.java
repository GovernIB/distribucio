 ...
 * 
 */
@WebServiceClient(name = "BackofficeFacadeService", targetNamespace = "urn:es:caib:bantel:ws:v2:services", wsdlLocation = "file:/C:/Feina/WORKSPACES/workspace_ripea/distribucio/distribucio-plugin-impl/wsdl/sistra-bantel/BackofficeFacade.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Feina/WORKSPACES/workspace_ripea/distribucio/distribucio-plugin-impl/wsdl/sistra-bantel/BackofficeFacade.wsdl");
