...
public class ValidacioFirmaApiTest {
	...
	private static final String API_ENDPOINT_ADDRESS = "https://proves.caib.es/portafibapi/interna";
	private static final String API_USERNAME = "$distribucio_portafib_pre";
	private static final String API_PASSWORD = "distribucio_portafib_pre";
