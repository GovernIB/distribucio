...
public class BustiaV1Test {
	...
	private static final String PROCEDIMENT_CODI = null; //"1234" //PRE	//"208133" //DEV // "208002" prova regles //DES "BACK_HELIUM" backoffice Helium
	private static final String USUARI_CODI = "u104848";
	private static final String USUARI_NOM = "VHZ";
	private static final String EXTRACTE = "Prova backoffice anotació triplicada " + new SimpleDateFormat("yyyy.MM.dd HH.mm.ss").format(new Date()) ;
