...
public class BustiaV1Test2 {
	...
	private static final String PROCEDIMENT_CODI = "215980"; //"BACK_DIST_232" //"1234" //PRE	//"208133" //DEV // "208002" prova regles //DES "BACK_HELIUM" backoffice 
	...
	private static final String EXTRACTE = "Anotació RIPEA" + new SimpleDateFormat("yyyy.MM.dd HH.mm.ss").format(new Date());
