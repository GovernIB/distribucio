package es.caib.distribucio.plugin.properties;
...
public abstract class DistribucioAbstractPluginProperties {
	...
	public DistribucioAbstractPluginProperties(String propertyKeyBase) {
		this(propertyKeyBase, (Properties) null);
	}

	public DistribucioAbstractPluginProperties(String propertyKeyBase, Properties properties) {
