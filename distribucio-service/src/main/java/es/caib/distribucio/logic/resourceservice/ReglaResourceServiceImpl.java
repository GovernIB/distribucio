 ...
 * <p>
 * Les accions ACTIVAR/DESACTIVAR ja tenen {@code ActionExecutor} registrat. La resta d'accions
 * declarades a {@link ReglaResource} (APLICAR_MANUALMENT, AMUNT, AVALL, ACCIO_MASSIVA) encara no
 * s'han desenvolupat: si s'invoquessin, el motor genèric respon amb un {@code ArtifactNotFoundException}.
 *
