...
public class DistribucioWsApp extends SpringBootServletInitializer {

	public static void main(String[] args) {
		SpringApplication.run(DistribucioWsApp.class, args);
	}
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		try {
			...
			log.info("Carregant l'aplicació " + BaseConfig.APP_NAME + "-ws versió " + version + " generada en data " + buildTimestamp);
