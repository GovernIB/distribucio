 ...
 */
@Slf4j
@Configuration("wsJBossWebSecurityConfig")
@EnableWebSecurity
@ConditionalOnWarDeployment
public class JBossWebSecurityConfig extends BaseWebSecurityConfig {

	@Value("${es.caib.distribucio.security.mappableRoles:" + BaseConfig.ROLE_SUPER + "," + BaseConfig.ROLE_BUSTIA_WS + "," + BaseConfig.ROLE_BACKOFFICE_WS + "}")
	...
	@Value("${es.caib.distribucio.security.resourceAcces.ws:#{null}}")
