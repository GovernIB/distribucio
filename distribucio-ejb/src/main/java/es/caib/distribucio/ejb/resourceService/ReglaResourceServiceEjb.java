...
public class ReglaResourceServiceEjb extends AbstractServiceEjb<ReglaResourceService> implements ReglaResourceService {

    @Delegate
    private ReglaResourceService delegate = null;

    @Override
    protected void setDelegateService(ReglaResourceService delegate) {
