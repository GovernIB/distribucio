...
public class ContingutResourceServiceEjb extends AbstractServiceEjb<ContingutResourceService> implements ContingutResourceService {

    @Delegate
    private ContingutResourceService delegate = null;

    @Override
    protected void setDelegateService(ContingutResourceService delegate) {
