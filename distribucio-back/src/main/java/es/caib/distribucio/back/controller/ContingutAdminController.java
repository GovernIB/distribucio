...
import es.caib.distribucio.back.command.ContingutFiltreCommand;
import es.caib.distribucio.back.command.ContingutFiltreCommand.ContenidorFiltreOpcionsEsborratEnum;
