...
@RequestMapping(BaseConfig.API_PATH + "/comentaris")
public class ContingutComentariResourceController extends BaseMutableResourceController<ContingutComentariResource, Long> {}