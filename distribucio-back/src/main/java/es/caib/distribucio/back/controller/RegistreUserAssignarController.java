...
import es.caib.distribucio.back.command.RegistreAssignarCommand;
...
public class RegistreUserAssignarController extends BaseUserController {
	...
	private boolean isPermesAssignarAnotacions() {
		return Boolean.valueOf(aplicacioService.propertyFindByNom("es.caib.distribucio.assignar.anotacions"));
	}
