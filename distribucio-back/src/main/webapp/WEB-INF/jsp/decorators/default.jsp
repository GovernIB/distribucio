...
<%
	pageContext.setAttribute(
			"sessionEntitats",
			es.caib.distribucio.back.helper.EntitatHelper.findEntitatsAccessibles(request));
	pageContext.setAttribute(
			"entitatActual",
			es.caib.distribucio.back.helper.EntitatHelper.getEntitatActual(request));
	pageContext.setAttribute(
			"countElementsPendentsBusties",
			es.caib.distribucio.back.helper.ElementsPendentsBustiaHelper.countElementsPendentsBusties(request));
	pageContext.setAttribute(
			"requestParameterCanviEntitat",
			es.caib.distribucio.back.helper.EntitatHelper.getRequestParameterCanviEntitat());
	pageContext.setAttribute(
			"dadesUsuariActual",
			es.caib.distribucio.back.helper.SessioHelper.getUsuariActual(request));
	pageContext.setAttribute(
			"rolActual",
			es.caib.distribucio.back.helper.RolHelper.getRolActual(request));
	pageContext.setAttribute(
			"rolsUsuariActual",
			es.caib.distribucio.back.helper.RolHelper.getRolsUsuariActual(request));
	pageContext.setAttribute(
			"isRolActualSuperusuari",
			es.caib.distribucio.back.helper.RolHelper.isRolActualSuperusuari(request));
	pageContext.setAttribute(
	...
	pageContext.setAttribute(
			...
			es.caib.distribucio.back.helper.RolHelper.getRequestParameterCanviRol());
	pageContext.setAttribute(
			"avisos",
			es.caib.distribucio.back.helper.AvisHelper.getAvisos(request));
	pageContext.setAttribute(
			"isMetadadesActives",
