...
$(document).ready(function() {
	$('select#tipus').change(function() {
		if ($(this).val() == 'DOMINI') {
			...
			$.ajax({
				type: 'GET',
				url: "<c:url value="/metaDada/domini"/>",
...
<body>
	<form:form action="." method="post" cssClass="form-horizontal" modelAttribute="metaDadaCommand">
		...
		<dis:inputText name="codi" textKey="metadada.form.camp.codi" required="true"/>
		<dis:inputText name="nom" textKey="metadada.form.camp.nom" required="true"/>
		<dis:inputSelect name="tipus" textKey="metadada.form.camp.tipus" optionEnum="MetaDadaTipusEnumDto" disabled="${metaDadaCommand.id!=null && existContingut}"/>
		<form:hidden path="tipus" id="tipushidden"/>
		<dis:inputSelect name="multiplicitat" textKey="metadada.form.camp.multiplicitat" optionEnum="MultiplicitatEnumDto"/>
		...
		<dis:inputSelect name="domini" textKey="metadada.form.camp.domini"/>
		<dis:inputCheckbox name="noAplica" textKey="metadada.form.camp.noaplica"/>
		
		<dis:inputTextarea name="descripcio" textKey="metadada.form.camp.descripcio"/>
		<div id="modal-botons">
