...
const MassiveActionSelector: React.FC<MassiveActionSelectorProps> = (props: MassiveActionSelectorProps) => {
    ...
    const handleSelectAll = () => {
        if (apiIsReady) {
            apiFindAll({ unpaged: true, filter: filter, namedQueries: namedQueries }).then((app) => {
    ...
    const buttonActions = [
        {
            label: t('component.MassiveActionSelector.all'),
            icon: 'check_box',
            showInMenu: true,
        ...
        {
            label: t('component.MassiveActionSelector.clear'),
                ...
                <ButtonGroup variant="outlined" size="small" className={'massive-selector'}>
                    ...
                    {menuActions?.length !== 0 && (
                        <MenuActionButton
                            id={'massiveOpcions'}
                            entity={selectedRows}
                            buttonLabel={t('component.MassiveActionSelector.options')}
                            buttonProps={{
