...
export type Pantalla = 'home' | 'entitat' | 'avis' | 'servei' | 'unitatOrganitzativa' | 'bustiaAdmin' | 'bustiaAdminOrganigrama' | 'limitCanviEstat' | 'procediment' | 'permis' | 'contingut' | 'config';
