<%@page import="es.caib.distribucio.war.helper.EnumHelper"%>
...
java.util.List<EnumHelper.HtmlOption> estatExpedientEnum = EnumHelper.getOptionsForEnum(
		es.caib.distribucio.core.api.dto.ExpedientEstatEnumDto.class,
...
<input id="mfns" type="hidden" value="${mfns}"/>
	<form:form action="" method="post" cssClass="well" commandName="expedientFiltreCommand">
		<div class="no-margin-bottom no-padding-left no-padding-right col-sm-9 collapse in">
			<dis:inputText name="search" inline="true" placeholderKey="expedient.list.user.placeholder.expedient"/>
		</div>
		<div class="no-padding-left col-sm-4 collapse">
			<dis:inputText name="numero" inline="true" placeholderKey="expedient.list.user.placeholder.numero"/>
		</div>
		<div class="col-sm-4 collapse">
			<dis:inputText name="nom" inline="true" placeholderKey="expedient.list.user.placeholder.titol"/>
		</div>
		<div class="no-padding-right col-sm-4 collapse">
			<dis:inputSelect name="tipusId" optionItems="${expedientTipus}" optionValueAttribute="id" optionTextAttribute="identificador" emptyOption="true" placeholderKey="expedient.list.user.placeholder.tipus" inline="true"/>
		</div>
		<div class="no-margin-bottom  no-padding-left col-sm-4 collapse">
			<dis:inputSelect name="arxiuId" optionItems="${arxius}" optionValueAttribute="id" optionTextAttribute="nom" emptyOption="true" placeholderKey="expedient.list.user.placeholder.arxiu" inline="true"/>
		</div>
		<div class="no-margin-bottom col-sm-4 collapse">
			<dis:inputSelect name="estat" optionItems="${estatExpedientEnum}" optionTextKeyAttribute="text" optionValueAttribute="value" emptyOption="true" placeholderKey="expedient.list.user.placeholder.estat" inline="true"/>
		</div>
