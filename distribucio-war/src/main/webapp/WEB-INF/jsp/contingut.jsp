...
<head>
	...
	<c:set var="titleIconClass"><dis:blocIconaContingut contingut="${contingut}" nomesIconaNom="true"/></c:set>
...
var officeExecAttributes = {
		id: 'officeExecApplet',
		code: 'es.caib.distribucio.applet.OfficeExecApplet.class',
		archive: '<c:url value="/applet/distribucio-applet.jar"/>',
		width: 1,
		height: 1};
		...
		<c:if test="${contingut.expedient or contingut.carpeta or contingut.document}">
			...
			<div class="col-md-3">
				...
				<div id="contenidor-info" class="well">
					...
					<dis:blocContenidorAccions id="botons-accions-info" contingut="${contingut}" modeLlistat="true" mostrarObrir="false"/>
				</div>
				<%--                     --%>
				<%-- /Columna informació --%>
				<%--                     --%>
