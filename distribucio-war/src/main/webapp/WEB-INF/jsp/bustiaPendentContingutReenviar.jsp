...
<body>
	<form:form action="" class="form-horizontal" commandName="contenidorMoureCopiarEnviarCommand">
		...
		<dis:inputFixed textKey="contenidor.enviar.camp.origen">
			<dis:blocIconaContingut contingut="${contingutPendent}"/>
			${contingutOrigen.nom}
		</dis:inputFixed>
		<dis:inputArbre name="destiId" textKey="contenidor.enviar.camp.desti" arbre="${arbreUnitatsOrganitzatives}" required="true" fulles="${busties}" fullesAtributId="id" fullesAtributNom="nom" fullesAtributPare="unitatCodi" fullesIcona="fa fa-inbox fa-lg" isArbreSeleccionable="${false}" isFullesSeleccionable="${true}" isOcultarCounts="${true}"/>
		<dis:inputTextarea name="comentariEnviar" textKey="contenidor.enviar.camp.comentari"/>
