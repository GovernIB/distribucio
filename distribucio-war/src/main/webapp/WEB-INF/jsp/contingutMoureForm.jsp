...
<body>
	<form:form action="" class="form-horizontal" commandName="contingutMoureCopiarEnviarCommand">
		...
		<dis:inputFixed textKey="contingut.moure.camp.origen">
			<dis:blocIconaContingut contingut="${contingutOrigen}"/>
			${contingutOrigen.nom}
		</dis:inputFixed>
		<dis:inputFileChooser name="destiId" contingutOrigen="${contingutOrigen}" textKey="contingut.moure.camp.desti" required="true"/>
