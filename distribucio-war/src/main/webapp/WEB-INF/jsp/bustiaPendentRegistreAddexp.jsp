...
<body>
	<form:form action="" class="form-horizontal" commandName="contenidorMoureCopiarEnviarCommand">
		...
		<dis:inputFileChooser name="destiId" contingutOrigen="${contenidorOrigen}" textKey="bustia.pendent.registre.addexp.camp.desti" ocultarDocuments="true" ocultarCarpetes="true" required="true"/>
