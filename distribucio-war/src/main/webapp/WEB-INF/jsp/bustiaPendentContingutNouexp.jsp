...
<body>
	<form:form action="" method="post" cssClass="form-horizontal" commandName="expedientCommand">
		...
		<dis:inputSelect name="metaNodeId" textKey="contingut.expedient.form.camp.metanode" required="true" optionItems="${metaExpedients}" optionValueAttribute="id" optionTextAttribute="nom" disabled="${not empty expedientCommand.id}"/>
		<dis:inputSelect name="arxiuId" textKey="contingut.expedient.form.camp.arxiu" required="true" optionItems="${arxius}" optionValueAttribute="id" optionTextAttribute="nomAmbUnitat"/>
		<dis:inputText name="nom" textKey="contingut.expedient.form.camp.nom" required="true"/>
