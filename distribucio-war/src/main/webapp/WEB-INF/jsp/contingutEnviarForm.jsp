...
<body>
	<form:form action="" class="form-horizontal" commandName="contingutMoureCopiarEnviarCommand">
		...
		<dis:inputFixed textKey="contingut.enviar.camp.origen">
			<dis:blocIconaContingut contingut="${contingutOrigen}"/>
			${contingutOrigen.nom}
		</dis:inputFixed>
		<dis:inputArbre name="destiId" textKey="contingut.enviar.camp.desti" arbre="${arbreUnitatsOrganitzatives}" required="true" fulles="${busties}" fullesAtributId="id" fullesAtributNom="nom" fullesAtributPare="unitatCodi" fullesIcona="fa fa-inbox fa-lg" isArbreSeleccionable="${false}" isFullesSeleccionable="${true}" isOcultarCounts="${true}"/>
		<dis:inputTextarea name="comentariEnviar" textKey="contingut.enviar.camp.comentari" required="false"/>
